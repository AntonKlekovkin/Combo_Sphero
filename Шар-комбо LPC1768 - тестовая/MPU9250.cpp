...
void MPU9250::InitMPU(Serial *uart)
{
	
	
	// Read the WHO_AM_I register, this is a good test of communication
		uint8_t whoami = readByte(MPU9250_ADDRESS, WHO_AM_I_MPU9250);  // Read WHO_AM_I register for MPU-6050
...
void MPU9250::CalculateGyroData()
{
    ...
    gx = ((float)gyroCount[0]*gRes - gyroBias[0])/57.3;  // radian per second
    gy = ((float)gyroCount[1]*gRes - gyroBias[1])/57.3;  
    gz = ((float)gyroCount[2]*gRes - gyroBias[2])/57.3;   
